# Academic Website -- Content Checklist
...
### 1. From MIRAGE to CLEAR
- **Title:** From MIRAGE to CLEAR: Component-Level Explainable Anomaly Reasoning for Autonomous Vehicle Perception Systems
- **Authors:** David Fernandez, Pedram MohajerAnsari, Cigdem Kokenoz, Amir Salarpour, Bing Li, Mert D. Pese
- **Venue:** IEEE/IFIP International Conference on Dependable Systems and Networks (DSN 2026)
- **Link:** https://github.com/David-FR/VLMsPatchAttack
- **Status:** To appear

### 2. WIP: From Detection to Explanation
- **Title:** WIP: From Detection to Explanation: Using LLMs for Adversarial Scenario Analysis in Vehicles
- **Authors:** David Fernandez, Pedram MohajerAnsari, Cigdem Kokenoz, Amir Salarpour, Bing Li, Mert D. Pese
- **Venue:** 3rd USENIX Symposium on Vehicle Security and Privacy (VehicleSec 2025), Seattle, WA -- August 2025
- **Link:** https://www.usenix.org/system/files/vehiclesec25-fernandez.pdf
- **Status:** Published

### 3. SASA: Sequence-Aware Shadow Attacks
- **Title:** SASA: Sequence-Aware Shadow Attacks via Attention Alignment for Traffic Sign Recognition
- **Authors:** Amir Salarpour, Pedram MohajerAnsari, David Fernandez, Mert D. Pese
- **Venue:** 6th Workshop on Adversarial Machine Learning on Computer Vision: Safety of Vision-Language Agents (AdvML@CVPR)
- **Link:** https://openreview.net/pdf?id=UNf8Vo6sPF
- **Status:** Published
...
- **Venue:** SAE Technical Paper 2025-01-8213 -- April 2025
- **Link:** /files/publications/fernandez-2025-avoiding-the-crash.pdf
- **Status:** Published

### 5. Small Language Models on the Edge
- **Title:** Small Language Models on the Edge for Real-World Agentic Systems in Industry
- **Authors:** Edward B. Duffy et al. (co-author)
- **Venue:** Southern African Conference for Artificial Intelligence Research (SACAIR), Cape Town -- December 2025
- **Link:** https://www.researchgate.net/profile/Alta-De-Waal/publication/398318643_Small_Language_Models_on_the_Edge_for_Real-World_Agentic_Systems_in_Industry/links/69313ccc7e61d05b530bb267/Small-Language-Models-on-the-Edge-for-Real-World-Agentic-Systems-in-Industry.pdf
- **Status:** Published
...
- **Authors:** David Fernandez, Pedram MohajerAnsari, Amir Salarpour, Mert D. Pese
- **Venue:** SAE Technical Paper 2026-01-0170, WCX SAE World Congress Experience -- April 2026
- **Link:** /files/publications/fernandez-2026-adversarial-transferability-vlm.pdf
- **Status:** Published

### 7. Attention-Aware Temporal Adversarial Shadows
...
- **Google Scholar:** https://scholar.google.com/citations?user=KICgEp8AAAAJ&hl=en
- **GitHub:** https://github.com/David-FR/VLMsPatchAttack
- **LinkedIn:** www.linkedin.com/in/david-fernan
- **ORCID:** 0009-0006-6531-0490

---

## CV

- PDF path: CV/CV_DavidFernandez.pdf
